...
<p style="margin: 4px 0 10px;">Your order has accepted, We will deliver as soon as possible.</p>
...
<p style="margin: 4px 0 10px;">You can check your order by click <a href="<?=Url::to(['user/detail', 'id' => $order->id], true);?>" target="_blank" style='text-decoration: none; color: #ffc107'>here</a>.</p>
