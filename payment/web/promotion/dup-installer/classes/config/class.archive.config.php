...
class DUPX_ArchiveConfig
{
    ...
    public function setNewPathsAndUrlParamsByMainNew()
    {
        ...
        self::setNewParamUrl(DUPX_Paramas_Manager::PARAM_SITE_URL_OLD, DUPX_Paramas_Manager::PARAM_SITE_URL, $oldHomeUrl, $newHomeUrl, true);
        self::setNewParamUrl(DUPX_Paramas_Manager::PARAM_URL_CONTENT_OLD, DUPX_Paramas_Manager::PARAM_URL_CONTENT_NEW, $oldHomeUrl, $newHomeUrl, true);
        self::setNewParamUrl(DUPX_Paramas_Manager::PARAM_URL_UPLOADS_OLD, DUPX_Paramas_Manager::PARAM_URL_UPLOADS_NEW, $oldHomeUrl, $newHomeUrl, true);
        self::setNewParamUrl(DUPX_Paramas_Manager::PARAM_URL_PLUGINS_OLD, DUPX_Paramas_Manager::PARAM_URL_PLUGINS_NEW, $oldHomeUrl, $newHomeUrl, true);
        self::setNewParamUrl(DUPX_Paramas_Manager::PARAM_URL_MUPLUGINS_OLD, DUPX_Paramas_Manager::PARAM_URL_MUPLUGINS_NEW, $oldHomeUrl, $newHomeUrl, true);
        ...
        self::setNewParamPath(DUPX_Paramas_Manager::PARAM_PATH_WP_CORE_OLD, DUPX_Paramas_Manager::PARAM_PATH_WP_CORE_NEW, $oldMainPath, $newMainPath, true);
        self::setNewParamPath(DUPX_Paramas_Manager::PARAM_PATH_CONTENT_OLD, DUPX_Paramas_Manager::PARAM_PATH_CONTENT_NEW, $oldMainPath, $newMainPath, true);
        self::setNewParamPath(DUPX_Paramas_Manager::PARAM_PATH_UPLOADS_OLD, DUPX_Paramas_Manager::PARAM_PATH_UPLOADS_NEW, $oldMainPath, $newMainPath, true);
        self::setNewParamPath(DUPX_Paramas_Manager::PARAM_PATH_PLUGINS_OLD, DUPX_Paramas_Manager::PARAM_PATH_PLUGINS_NEW, $oldMainPath, $newMainPath, true);
        self::setNewParamPath(DUPX_Paramas_Manager::PARAM_PATH_MUPLUGINS_OLD, DUPX_Paramas_Manager::PARAM_PATH_MUPLUGINS_NEW, $oldMainPath, $newMainPath, true);
    ...
    protected static function setNewParamUrl($oldParamKey, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty)
    {
        $paramsManager = DUPX_Paramas_Manager::getInstance();
        $oldValue      = $paramsManager->getValue($oldParamKey);
        return self::setNewParamUrlByString($oldValue, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty);
    }

    protected static function setNewParamPath($oldParamKey, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty)
    {
        $paramsManager = DUPX_Paramas_Manager::getInstance();
        $oldValue      = $paramsManager->getValue($oldParamKey);
        return self::setNewParamByString($oldValue, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty);
    }

    protected static function setNewParamByString($oldValue, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty)
    {
        $paramsManager = DUPX_Paramas_Manager::getInstance();
        if ($setIfOnlyEmpty) {
            $newVal = $paramsManager->getValue($newParamKey);
            if (!empty($newVal)) {
                return;
            }
        }
    ...
    protected static function setNewParamUrlByString($oldValue, $newParamKey, $oldMain, $newMain, $setIfOnlyEmpty)
    {
        $paramsManager = DUPX_Paramas_Manager::getInstance();
        if ($setIfOnlyEmpty) {
            $newVal = $paramsManager->getValue($newParamKey);
    ...
    public function getSubsitesWithFormattedUrls()
    {
        ...
        if ($this->mu_mode == DUPX_MultisiteMode::Subdirectory) {
            $subsites = DUPX_U::urlForSubdirectoryMode($this->subsites, $this->getRealValue('homeUrl'));
        } else {
