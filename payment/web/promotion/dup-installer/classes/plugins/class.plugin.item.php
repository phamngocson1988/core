...
class DUPX_Plugin_item
{
    ...
    public function getPluginPath()
    {
        ...
        $mainDir      = false;
        if ($this->isMustUse()) {
            $mainDir = $paramManager->getValue(DUPX_Paramas_Manager::PARAM_PATH_MUPLUGINS_NEW);
        } else if ($this->isDropIns()) {
            $mainDir = $paramManager->getValue(DUPX_Paramas_Manager::PARAM_PATH_CONTENT_NEW);
        } else {
            $mainDir = $paramManager->getValue(DUPX_Paramas_Manager::PARAM_PATH_PLUGINS_NEW);
        }
