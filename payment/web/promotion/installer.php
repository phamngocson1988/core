...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20200812_promotionkinggems_78cde6a8d6c41a737776_20200812040645_archive.zip';
    const ARCHIVE_SIZE       = '81088052';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '78cde6a-12040645';
    const VERSION            = '3.8.7';
