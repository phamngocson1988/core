<tr>
  <td align="initial" dir="ltr" style="padding-bottom: 22px; font-weight: normal; font-size: 13px; line-height: 18px; color: #404041; text-align: left;">
    ...
    <p>Your password has been changed successfully on <?= date(DATE_RFC2822);?>
    If it was you, just ignore this email. If you have not done this, please contact us to protect your account.</p>
    <hr>
