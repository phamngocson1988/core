...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span>{Yii::t('module.shop', 'create_product')}</span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">{Yii::t('module.shop', 'create_product')}</h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    {ActiveForm assign='form' options=['class' => 'form-horizontal form-row-seperated']}
      <div class="portlet">
        <div class="portlet-title">
          <div class="caption">{Yii::t('module.shop', 'create_product')}</div>
...
$("#upload-gallery").selectImage(manager, {
  ...
  callback: function(imgs) {
    $.each( imgs, function( key, img ) {
      ...
      _html += '<input type="hidden" name="CreateProductForm[gallery][]" value="' + img.id + '">';
      _html += '</td>';
      _html += '<td>';
