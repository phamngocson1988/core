      ...
      <div class="modal-footer">
        <div class="btn-group">
          ...
          <ul role="size" class="dropdown-menu">
            <?php foreach (Yii::$app->params['thumbnails'] as $thumbnail) : ?>
            <?php $selected = $default_thumbnail == $thumbnail ? 'selected' : '';?>
            <li><a href="javascript:void(0)" class="<?=$selected;?>" value="<?=$thumbnail;?>"><i class="fa fa-check "></i> <span class="search-option"><?=$thumbnail;?></span></a></li>
            <?php endforeach;?>
          </ul>
        </div>
        <div class="btn-group">
