...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span>Thống kê khách hàng của tôi</span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">Thống kê khách hàng của tôi</h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        <div class="row margin-bottom-10">
          <?php $form = ActiveForm::begin(['method' => 'GET', 'action' => ['order/my-customer-report']]);?>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td style="vertical-align: middle;">
                    <a class=" btn yellow btn-outline sbold" href="<?=Url::to(['order/my-customer-orders', 'customer_id' => $model->customer_id, 'start_date' => $model->start_date, 'end_date' => $model->end_date, 'status' => $model->getReportStatus()]);?>" data-target="#ajax" data-toggle="modal"> <?=number_format($model->count_order);?> </a>
                </td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <img src="/vendor/assets/global/img/loading-spinner-grey.gif" alt="" class="loading">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
        </div>
    </div>
