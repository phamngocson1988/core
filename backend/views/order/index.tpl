...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span>{Yii::t('app', 'manage_orders')}</span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">{Yii::t('app', 'manage_orders')}</h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase"> {Yii::t('app', 'manage_orders')}</span>
        </div>
        <div class="actions">
          <div class="btn-group btn-group-devided">
            <a class="btn green" href="{url route='order/create' ref=$ref}">{Yii::t('app', 'add_new')}</a>
          </div>
        </div>
      </div>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td style="vertical-align: middle;">
                    ...
                    <a href='{url route="order/delete" id=$model->id ref=$ref}' class="btn btn-xs grey-salsa delete-action"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
              {/foreach}
          </tbody>
