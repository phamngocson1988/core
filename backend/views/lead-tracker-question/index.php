...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span>Quản lý lead tracker question</span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">Quản lý lead tracker question</h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase"> Quản lý lead tracker question</span>
        </div>
        <div class="actions">
          <div class="btn-group btn-group-devided">
            <a class="btn green" href="<?=Url::to(['lead-tracker-question/create']);?>"><?=Yii::t('app', 'add_new');?></a>
          </div>
        </div>
      </div>
      <div class="portlet-body">
        <table class="table table-striped table-bordered table-hover table-checkable" id="myTable">
          ...
          <tbody>
              ...
              <tr>
                <td class="center"><a href='<?=Url::to(['lead-tracker-question/edit', 'id' => $model->id]);?>'>#<?=$model->id;?></a></td>
