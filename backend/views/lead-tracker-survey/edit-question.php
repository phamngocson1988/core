...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <a href="<?=Url::to(['lead-tracker-survey/index'])?>">Quản lý lead tracker question</a>
      <i class="fa fa-circle"></i>
    </li>
    <li>
              ...
              <div class="tab-pane active" id="tab_general">
                <div class="form-body" id="vue-app">
                  ...
                  <?=$form->field($model, 'survey_id', [
                    ...
                    'template' => '{label}<div class="col-md-6">{input}{hint}{error}</div>',
                    'inputOptions' => ['class' => 'form-control']
                  ])->dropDownList($model->fetchSurveys());?>
                  <?=$form->field($model, 'type', [
                    'labelOptions' => ['class' => 'col-md-2 control-label'],
                    'template' => '{label}<div class="col-md-6">{input}{hint}{error}</div>',
                    'inputOptions' => ['class' => 'form-control', 'v-model' => 'type', 'disabled' => true]
                  ...
                  <div class="form-group" v-if="this.isShowOptions()">
                    ...
                    <div class="col-md-6">
                      <div class="input-group" style="margin-bottom: 10px" v-for="op in options" :key="op.id">
                        <input type="text" :value="op.value" :name="'EditLeadTrackerSurveyQuestionForm[options][' + op.id + ']'" class="form-control" @blur="(event) => addOptionValue(op.id, event)">
