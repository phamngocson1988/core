      ...
      <div class="portlet-title">
        ...
        <div class="actions">
          <div class="btn-group btn-group-devided">
            <a class="btn green" href="{url route='game1/create' ref=$ref}">{Yii::t('app', 'add_new')}</a>
          </div>
        </div>
      </div>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td style="vertical-align: middle;">
                    <a href='{url route="game1/edit" id=$model->id ref=$ref}' class="btn btn-xs grey-salsa tooltips" data-container="body" data-original-title="{Yii::t('app', 'edit')}" data-pjax="0"><i class="fa fa-pencil"></i></a>
                    <a href='{url route="game1/delete" id=$model->id ref=$ref}' class="btn btn-xs grey-salsa delete-action tooltips" data-container="body" data-original-title="{Yii::t('app', 'delete')}" data-pjax="0"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
              {/foreach}
          </tbody>
