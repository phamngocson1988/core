    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase"> Thống kê thực hiện đơn hàng theo nhà cung cấp</span>
        </div>
        <div class="actions">
        </div>
      </div>
      <div class="portlet-body">
        <?php $form = ActiveForm::begin(['method' => 'GET', 'action' => ['report/process-supplier']]);?>
        <div class="row">
          <?php $supplier = $search->getSupplier();?>
          <?=$form->field($search, 'supplier_id', [
            'options' => ['class' => 'form-group col-md-4 col-lg-3'],
          ])->widget(kartik\select2\Select2::classname(), [
            'initValueText' => ($search->supplier_id) ? sprintf("%s - %s", $supplier->username, $supplier->email) : '',
            ...
            <table class="table table-striped table-bordered table-hover table-checkable" data-sortable="true" data-url="<?=Url::to(['order/index']);?>">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=sprintf("Xử lý đơn hàng (#%s)", $model['id']);?></td>
                    <td><?=round($model['total_price']) . '%';?></td>
                    <td></td>
                  </tr>
                  <?php endforeach;?>
              </tbody>
