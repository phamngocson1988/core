...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span>Doanh số theo reseller</span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">Doanh số theo reseller</h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        <div class="row margin-bottom-10">
          <?php $form = ActiveForm::begin(['method' => 'GET', 'action' => ['report/sale-reseller']]);?>     
            ...
            <table class="table table-striped table-bordered table-hover table-checkable">
              <thead>
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center" rowspan="2"> Tên reseller </th>
