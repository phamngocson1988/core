...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <span><?=Yii::t('app', 'manage_section');?></span>
    </li>
  </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"><?=Yii::t('app', 'manage_section');?></h1>
<!-- END PAGE TITLE-->
<div class="row">
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase"> <?=Yii::t('app', 'manage_section');?></span>
        </div>
        <div class="actions">
      ...
      <?php $form = ActiveForm::begin(['method' => 'GET', 'action' => ['forum-section/index']]);?>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td class="left">
                  <a href='<?=Url::to(['forum-section/edit', 'id' => $model->id]);?>' class="btn btn-xs grey-salsa"><i class="fa fa-pencil"></i></a>
                </td>
              </tr>
              <?php endforeach;?>
          </tbody>
...
<?=\backend\widgets\LanguageModalWidget::widget(['url' => Url::to(['forum-section/create'])]);?>
