...
/**
 * AssignOrderTeamToOrderForm
 */
class AssignOrderTeamToOrderForm extends Model
{
    public $order_id;
    public $user_id;
    public $force_update = false;

    protected $allow_roles = ['orderteam', 'orderteam_manager'];
    private $_user;
    private $_order;
    ...
    public function validateOrder($attribute, $params)
    {
        ...
        if ($order->orderteam_id && !$this->force_update) {
            return $this->addError($attribute, "The order was taken by another OT member");
        }
    }
