...
// forms
use frontend\forms\FetchOrderForm;
...
class OrderController extends Controller
{
    ...
    {
        $request = Yii::$app->request;
        $model = new \frontend\forms\SurveyOrderForm([
            'id' => $id,
    ...
    public function actionCancel($id)
    {
        ...
        $model = new \frontend\forms\CancelOrderForm(['id' => $id]);
    ...
    public function actionView($id) 
    {
        ...
        $model = new \frontend\forms\UpdateOrderForm(['id' => $id]);
        $model->loadData();
    ...
    public function actionConfirm($id)
    {
        ...
        $model = new \frontend\forms\ConfirmOrderForm(['id' => $id]);
