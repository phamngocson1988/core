...
function onGooglePayLoaded() {
  ...
  .then(function(response) {
    if(response.result) {
      console.log("Ready to pay", response);
      createAndAddButton();
      // Add Google Pay button – createAndAddButton()
    } else {
      console.log("nable to pay using Google Pay");
...
function onGooglePaymentsButtonClicked() {
  console.log("Google pay button is clicked");
...
function performPayment(paymentData) {
  ...
  console.log('paymentMethodToken', paymentData);
