...
<main>
  <section class="section-module">
    <div class="container">
      <h1 class="sec-title"><?=Yii::t('app', 'Having trouble with an operator? We’re here to help!');?></h1>
      <div class="sec-content">
        <div class="mod-column form-complaints">
          ...
          <div class="widget-box mb-5 p-3 p-md-4">
            <p class="text-uppercase mb-2"><?=Yii::t('app', 'SELECT AN OPTION THAT BEST DESCRIBES THE ISSUE');?></p>
          ...
          <div class="widget-box mb-5 p-3 p-md-4">
            <div class="mb-5">
              <h2 class="sec-ttl mb-3"><?=Yii::t('app', 'Fill in the complaint submission form');?></h2>
              <div class="row mb-3">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="file-upload js-fileupload">
                    ...
                    <label for="inputGroupFile01"><i class="fas fa-paperclip"></i><span><?=Yii::t('app', 'ATTACH FILES');?></span></label>
                ...
                ])->checkbox()->label(sprintf('<span>%s</span>', Yii::t('app', 'I agree to the Terms &amp; Conditions and Privacy Policy')));?>

              </div>
            </div>
            <div class="mb-4">
              <h2 class="sec-ttl mb-3"><?=Yii::t('app', 'Following information will not be published');?></h2>
              <div class="row mb-3">
            ...
            <div class="text-center">
              <button class="btn btn-primary pl-3 pr-3" type="submit"><?=Yii::t('app', 'SUBMIT MY COMPLAINT');?></button>
            </div>
          </div>
          <?php ActiveForm::end();?>
        </div>
