          ...
          <div class="affiliate-bottom">
            <div class="aff-tabs">
              <div class="aff-tabs-nav">
                <a href="<?=Url::to(['affiliate/index']);?>"><span class="active" tab-content="#reward-feed">Reward Feed</span></a>
                <a href="javascript:void;"><span tab-content="#reflink">Members</span></a>
              </div>
