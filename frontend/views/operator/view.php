      ...
      <div class="sec-content">
        <div class="mod-column">
          ...
          <section class="operator-review-rate">
            <h2 class="sec-title text-center">Henderson &amp; Bench Reviews By Players</h2>
                ...
                <div class="rate-content">
                  ...
                  <div class="rate-star">
                    <div class="star-group">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="#D8D8D8">
          ...
          <section class="operator-review-group widget-box">
            <div class="review-header">
              <div class="header-buttons"><a class="btn-text sortable is-down js-btn-sort" href="#">Sort by date</a><a class="btn-text sortable is-down js-btn-sort" href="#">Sort by date</a>
                <div class="btn-text" href="#">Average rating 8.1 of 1,562 reviews</div>
              </div>
            </div>
          ...
          <section class="operator-review-form widget-box" id="write-review-section">
            ...
            <div class="formrv-main">
              ...
              <div class="formrv-inputs">
                ...
                <div class="formrv-row row-dislike">
                  <textarea class="form-control" rows="6" placeholder="What do you dislike?"></textarea>
                </div>
              </div>
              <div class="formrv-options">
                <div class="formrv-check">
                  <input class="form-check-input" id="review-option-1" type="checkbox">
                  <label class="form-check-label" for="review-option-1">Notify me about new player reviews on this page.</label>
                </div>
                <div class="formrv-check">
                  <input class="form-check-input" id="review-option-2" type="checkbox">
                  <label class="form-check-label" for="review-option-2">I declare that my review is based on my own experience and represents my genuine opinion of this operator.</label>
                </div>
              </div>
