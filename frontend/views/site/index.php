        ...
        <div class="isotope isotope-md row" data-isotope-layout="fitRows" data-isotope-group="movies" data-lightgallery="group">
          <div class="row">
            <div class="col-6 col-md-4 col-lg-3 col-xxl-2 isotope-item" data-filter="type 3">
              <!-- Thumbnail simple-->
              <div class="thumbnail-simple"><a class="thumbnail-simple-image-wrap" href="/game/view.html?id=1"><img class="thumbnail-simple-image" src="/images/landing-movie-1-270x400.jpg" alt="" width="270" height="400"/></a>
