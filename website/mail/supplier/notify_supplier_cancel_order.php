      ...
      <tbody>
        <tr>
          <td align="center" dir="ltr">
            <center><a href="<?=$detailUrl;?>" style="background:#178186;border-radius:3px;color:#ffffff;display:block;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;letter-spacing:1px;padding:12px 8px;text-decoration:none;font-size:12px!important;" target="_blank">
              XEM THÊM CHI TIẾT
              </a>
            </center>
          </td>
