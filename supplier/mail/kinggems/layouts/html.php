                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td align="initial" dir="ltr" style="padding-bottom: 22px; padding-top: 20px; font-weight: normal; font-size: 13px; line-height: 18px; color: #404041; text-align: left;">
                                      ...
                                      <span style="color:#E95D2B">KingGems.us</span><br/>
                                      <p style="font-size:10px;">This email is an automated notification, please do not reply. </p>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center"  valign="top">
                                      <a href="https://www.facebook.com/Kinggems.us" style="font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;text-decoration:none" target="_blank"><img alt="" border="0" src="https://thienanit.com/wp-content/uploads/2020/05/facebook.png" style="display:block;height:auto;padding: 0px 5px;" width="25"> </a>
                                    </td>
                                    <td width="15" >&nbsp;</td>
                                    <td align="center"  valign="top">
